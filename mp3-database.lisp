(defpackage :com.chens.mp3-database
  (:use :common-lisp
        :com.chens.pathnames
        :com.chens.macro-utilities
        :com.chens.id3v2)
...
(defun matching (table &rest names-and-values)
  "Build a where function that matchers rows with the given column values."
...
;; select all rows where :artist column is "Green Day"
...
(defun random-sample (vector n)
  "Based on Algorithm S from Knuth. TAOCP, vo1. 2. p. 142"
